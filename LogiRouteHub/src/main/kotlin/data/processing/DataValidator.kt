...
fun buildPackageFromColumns(columnValuesList: List<String>): PackageRaw {
    ...
    val originHubId = columnValuesList[3]
    val packagePriorityEnum = Priority.fromString(columnValuesList[4])


    return PackageRaw(packageIdText, packageWeightValue,destinationHubIdText, originHubId,packagePriorityEnum)
}
...
fun buildWarehouseFromColumns(columnValuesList: List<String>): WarehouseRaw {
    ...
    val warehouseLatitude = convertTextToDecimalNumberOrDefault(columnValuesList[3])
    val warehouseLongitude = convertTextToDecimalNumberOrDefault(columnValuesList[4])


    return WarehouseRaw(warehouseIdText, warehouseNameText, warehouseRegionalZoneText,warehouseLatitude,warehouseLongitude)
}
